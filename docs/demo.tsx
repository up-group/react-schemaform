    ...
    properties: {
        ...
        customer_code: {
            ...
            targetPropertyValueGeneration: {
                targetProperty: "univers_autogenerated",
                calculateValue: (args) => {
                    // return 'Aides Sociales' if args starts with 'UP-A3'
                    if (args.startsWith('UP-A3')) {
                        return 'Aides Sociales';
                    }
                    if (args.startsWith('UP-A1')) {
                        return 'Repas';
                    }
                    return '';
                }
