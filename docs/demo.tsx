...
class Demo extends React.Component<{}, DemoState> {
  constructor(p, c) {
    ...
    this.state = {
      nb: 55,
      result: "",
      schema:{"definitions":{"PaginationProperties":{"type":["object","null"],"default":null,"properties":{"page_number":{"type":"integer","default":0},"page_size":{"type":"integer","default":0},"sort_property_name":{"type":["string","null"],"default":null},"sort_order":{"type":["integer","null"],"default":null}}}},"type":"object","properties":{"pagination_properties":{"$ref":"#/definitions/PaginationProperties","hide":true},"establishment_id":{"title":"Établissement","type":["string","null"],"default":null,"format":"entityKey","entitySource":{"endPoint":"https://up-france-odi-services-customer-test-app.azurewebsites.net/","queryParameterName":"search","text":"name","id":"id","query":"v1/establishements/searchestablishment"}},"start_date":{"title":"Date de début","type":["string","null"],"default":null,"format":"date"},"end_date":{"title":"Date de fin","type":["string","null"],"default":null,"format":"date"},"settlement_reference":{"title":"Numéro de télécollecte","type":["string","null"],"default":null}, "active":{"title":"Activé","type":"boolean","default":false, isToggle: false}, "transaction_status":{"title":"Status","enumNames":[null,"Authorized","Validated","Canceled","Denied"],"enumDescriptions":[null,"Authorized","Validated","Canceled","Denied"],"type":["integer","null"],"default":null,"format":"enum","enum":[null,1,2,3,4]}},"viewModels":[{"colspan":5,"order":1,"name":"settlement_reference"},{"colspan":5,"order":2,"name":"start_date"},{"colspan":5,"order":3,"name":"end_date"},{"colspan":5,"order":4,"name":"establishment_id"},{"colspan":24,"order":5,"name":"transaction_status"}]},
      hasError: false,
      showError: false,
      dataS: {}
    };
