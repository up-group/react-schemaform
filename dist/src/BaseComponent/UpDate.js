...
var UpDateComp = (function (_super) {
    ...
    UpDateComp.prototype.renderField = function () {
        return React.createElement(react_controls_1.UpDate, { value: "", onChange: this.handleChangeEventGlobal, hasError: this.state.hasError, isNullable: this.isNullable });
    };
