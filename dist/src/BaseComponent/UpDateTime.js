...
var UpDateTimeComp = (function (_super) {
    ...
    UpDateTimeComp.prototype.renderField = function () {
        return React.createElement(react_controls_1.UpDateTime, { value: "", onChange: this.handleChangeEventGlobal, hasError: this.state.hasError, isNullable: this.isNullable });
    };
