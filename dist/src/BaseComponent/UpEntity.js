...
var UpEntity = (function (_super) {
    ...
    UpEntity.prototype.renderField = function () {
        var _this = this;
        return React.createElement(react_controls_1.UpSelect, { ref: function (input) { _this.UpSelect = input; }, default: null, isNullable: this.isNullable, isRequired: this.props.isRequired, getFullData: false, multiple: this.isArray, placeholder: "Recherche", allowClear: !this.props.isRequired, onChange: this.handleChangeJsEventGlobal, onError: this.props.onError, dataSource: this.schema.entitySource });
    };
