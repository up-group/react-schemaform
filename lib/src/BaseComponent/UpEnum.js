...
var UpEnum = (function (_super) {
    ...
    UpEnum.prototype.renderField = function () {
        ...
        return React.createElement(react_controls_1.UpSelect, { default: this.schema.default, isNullable: this.isNullable, isRequired: this.props.isRequired, minimumInputLength: 0, placeholder: "Recherche", multiple: this.isArray, allowClear: !this.props.isRequired, onChange: this.handleChangeEventGlobal, data: options, onError: function () { } });
    };
